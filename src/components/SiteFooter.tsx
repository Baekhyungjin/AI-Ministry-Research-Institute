  ...
  return (
    <footer className="site-footer">
      <div className="container footer-grid institutional-footer-grid">
        <div className="footer-brand"><span className="footer-official-logo"><Image src="/images/brand/ministry-ai-logo.png" alt="목회AI연구소 공식 로고" fill sizes="72px" /></span><span className="footer-wordmark">목회AI연구소 <small>MINISTRY AI LAB</small></span><h2>기술보다 사람을,<br />도구보다 사명을 먼저.</h2><p>목회자가 말씀과 사람에게 더 집중하도록<br />AI 활용의 바른 기준과 실제 방법을 연구합니다.</p></div>
        <div><h3>연구소</h3><Link href="/about">연구소 소개</Link><Link href="/projects">사역 프로젝트</Link><Link href="/notices">공지사항</Link><Link href="/site-map">전체 사이트맵</Link><Link href="/admin">관리자</Link></div>

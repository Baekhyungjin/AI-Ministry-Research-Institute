  ...
  return (
    <footer className="site-footer">
      <div className="container footer-grid institutional-footer-grid">
        <div className="footer-brand"><span className="footer-official-logo"><BrandSymbol /></span><span className="footer-wordmark">목회AI연구소 <small>MINISTRY AI LAB</small></span><h2>기술보다 사람을,<br />도구보다 사명을 먼저.</h2><p>목회자가 말씀과 사람에게 더 집중하도록<br />AI 활용의 바른 기준과 실제 방법을 연구합니다.</p></div>

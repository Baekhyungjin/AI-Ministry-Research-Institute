...
export default function PrivacyPage() {
  return <section className="page-section soft-section"><div className="narrow-container privacy-page">
    ...
    <section><h2>1. 수집하는 정보</h2><p>성함, 교회·기관명, 직분·역할, 연락처, 이메일, 문의·신청 내용과 일정 정보를 수집합니다. 유료 세미나와 다시보기 후원 신청에서는 입금자명, 신청 금액, 입금 상태와 채팅방 안내 확인 여부를 추가로 수집합니다. 홈페이지 이용 과정에서는 브라우저에서 임의 생성한 식별자, 방문 경로, 게시물 조회·공유 기록, 유입 도메인, 기기 유형과 캠페인 식별 정보가 수집될 수 있습니다. 홈페이지 분석 기능은 원본 IP 주소를 저장하지 않습니다.</p></section>
    <section><h2>2. 이용 목적</h2><p>강의·협업·파트너·교육·다시보기 신청 확인, 일정 조율, 입금 확인, 신청자 안내와 문의 답변을 위해 사용합니다. 방문·조회 정보는 홈페이지 이용 현황과 콘텐츠 반응을 파악하고 서비스를 개선하는 데 사용합니다.</p></section>
    <section><h2>3. 보유 및 파기</h2><p>신청 정보는 처리 목적을 달성한 날부터 1년 동안, 방문 통계 정보는 수집일부터 13개월 동안 보관한 뒤 안전하게 파기합니다. 관계 법령에 따라 별도의 보존이 필요한 경우에는 해당 기간 동안 분리해 보관합니다.</p></section>
